...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\Contracts\BookingService' => \App\Services\BookingService::class,
    ...
    override(\config(), map([
            ...
            'bhb.max_guests' => 'string',
            'bhb.approval_ttl' => 'integer',
            'bhb.location' => 'string',
            'bhb.google.credentials_json' => 'string',
            'bhb.google.calendar_id' => 'string',
            'bhb.google.timezone' => 'string',
            'bhb.google.impersonate' => 'NULL',
...
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','bhb.max_guests','bhb.approval_ttl',
'bhb.location','bhb.google.credentials_json','bhb.google.calendar_id','bhb.google.timezone','bhb.google.impersonate',
...
'livewire.update','livewire.upload-file','livewire.preview-file','availability','book','dashboard',
...
'components.layouts.auth.simple','components.layouts.auth.split','components.layouts.front_office','components.placeholder-pattern','components.settings.layout',
...
'e60dd9d2c3a62d619c9acb38f20d5aa5::navlist.group','emails.admin.approval-request','flux.icon.book-open-text','flux.icon.chevrons-up-down','flux.icon.folder-git-2',
...
'livewire.auth.register','livewire.auth.reset-password','livewire.auth.verify-email','livewire.availability','livewire.booking-form',
...
'partials.settings-heading','~.code.personal.malca.bhb','e60dd9d2c3a62d619c9acb38f20d5aa5::accent','e60dd9d2c3a62d619c9acb38f20d5aa5::aside','e60dd9d2c3a62d619c9acb38f20d5aa5::avatar.group',
...
'e60dd9d2c3a62d619c9acb38f20d5aa5::with-reversed-inline-field','e60dd9d2c3a62d619c9acb38f20d5aa5::with-tooltip','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','GOOGLE_CREDENTIALS_JSON',
'GOOGLE_CALENDAR_ID','BHB_LOCATION','BOOKING_MAX_GUESTS','BOOKING_APPROVAL_TTL_HOURS',);
